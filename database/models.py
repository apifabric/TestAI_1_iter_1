...
#
# Created:  October 22, 2024 07:00:54
# Database: sqlite:////tmp/tmp.8i5bnWfncz/TestAI_1_iter_1/database/db.sqlite
# Dialect:  sqlite
#
# mypy: ignore-errors
########################################################################################################################
...
class Promotion(SAFRSBaseX, Base):
    ...
    # child relationships (access children)
    NewsList : Mapped[List["News"]] = relationship(back_populates="promotion")
...
class News(SAFRSBaseX, Base):
    ...
    # parent relationships (access parent)
    promotion : Mapped["Promotion"] = relationship(back_populates=("NewsList"))
