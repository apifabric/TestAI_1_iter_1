...
resourcename="testai1iter1"  # lower case, only
resourcegroup="testai1iter1_rg"
...
# git clone https://github.com/apilogicserver/testai1iter1.git
# cd testai1iter1
...
az group create --name testai1iter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group testai1iter1_rg --sku S1 --is-linux
az container create --resource-group testai1iter1_rg --name testai1iter1 --image apilogicserver/testai1iter1:latest --dns-name-label testai1iter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//testai1iter1.westus.azurecontainer.io:5656'
